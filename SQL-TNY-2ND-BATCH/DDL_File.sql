...
--Constrainst
  ...
  --  I can store only unique data but data can be null.
  -- Roll No
     1
	 2
	 null
  ...
  --3. PRIMARY KEY
    (unique key + not null)
	Cannot store duplicate as well as cannot store null
	Only unique data and not null value i can store.
  --4. FOREIGN key  Parent + child Relation ship
  
  
  --5. Check (Buisness rule)
